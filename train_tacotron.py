...
import hparams_custom_multihead as hp
from utils.text.symbols import symbols
from utils.paths import Paths
#from models.tacotron import Tacotron
from models.tacotron_gst_custom_multihead import Tacotron
#from models.tacotron_gst_pytorch_multihead import Tacotron
...
if __name__ == "__main__" :
    ...
    model = Tacotron(embed_dims=hp.tts_embed_dims,
                     ...
                     reference_depth=hp.reference_depth,
                     num_gst=hp.num_gst,
                     num_heads=hp.num_heads,
                     style_embed_depth=hp.style_embed_depth,
                     style_att_dim=hp.style_att_dim).cuda()
